    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @include('form.text',['var'=>['name'=>'first_name','label'=>'First Name', 'div'=>'col-md-12 npr']])
                @include('form.text',['var'=>['name'=>'last_name','label'=>'Last Name', 'div'=>'col-md-12 npr']])
                @include('form.text',['var'=>['name'=>'mobile','label'=>'Contact No.', 'div'=>'col-md-12 npr']])
                @include('form.text',['var'=>['name'=>'email','label'=>'Email', 'div'=>'col-md-12 npr']])
                @include('form.text',['var'=>['name'=>'password','type'=>'password','label'=>'Password','value'=>'', 'div'=>'col-md-12 npr']])
                @include('form.text',['var'=>['name'=>'password_confirmation','type'=>'password','label'=>'Confirm Password', 'div'=>'col-md-12 npr']])
