...
use App\Module;
use App\Project\Modules\SupportTickets\SupportTicketViewProcessor;
 ...
 * @var SupportTicket $element
 * @var SupportTicket $supportTicket
 * @var Tenant $tenant
 * @var SupportTicketViewProcessor $view
 */
        ...
        <div class="col-md-11 col-lg-9 col-xl-8">
            ...
            $levels = [
                [
                    ...
                    'query' => SupportTicketCategory::where('parent_id', 0),
                    'url_param' => 'parent_id',
                ],
                [
...
if ($element->isCreating()) {
    $options = [SupportTicket::SUPPORT_TICKET_STATUS_NEW];
}
?>
