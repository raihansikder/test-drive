...
class Response
{
    ...
    /** @var string A single-line message */
    public $message;
    ...
    /** @var string|\Illuminate\Contracts\View\Factory|\Illuminate\View\View|null */
    public $viewPath;
    ...
    /**
     * Metadata to be sent with the response.
     *
     * @var array
     */
    public $_meta = [];
    ...
    public function __construct()
    {
        ...
        if (request()->has('_meta')) {
            $this->_meta = array_filter(request('_meta'));
        }
    }
    ...
    */
    ...
    /**
     * Set a payload for the API 'data' field
     *
     * @param  mixed  $payload
     * @return $this
     */
     ...
     *
     * @param  string|\Illuminate\Contracts\View\Factory|\Illuminate\View\View|null  $viewPath
     * @param  array  $viewVars
    ...
    public function redirect($to = null)
    {
        ...
        // Only load input if the operation failed.
        if ($this->isFail()) {
            $redirect = $redirect->withInput();
        }

        $data = $this->defaultViewVars();
    ...
    /**
     * Convert an array key to snake_case
     *
     * @return array
     */
    ...
    */
    ...
    /**
     * Set response as fail due to a validation error
     *
     * @param  string  $message
     * @return $this
     */
    ...
    /**
     * Set a redirect to URL. This is a shorthand function for setRedirectTo
     *
     * @alias setRedirectTo
     *
    ...
    |--------------------------------------------------------------------------
    |
    | Helper functions that take care of some auxiliary features of the class
    |
    */
    ...
    {
        // Load from the session so that when redirected, the values are retained
        $array = [
            'response' => [
