...
trait RequestProcessorTrait
{
    ...
    public function attemptStore()
    {
        ...
        $this->success($this->storeSuccessMessage());
        $this->stored();
        $this->saved();
    ...
    public function attemptUpdate()
    {
        ...
        $this->success($this->updateSuccessMessage());
        $this->updated();
        $this->saved();
    ...
    public function attemptDestroy()
    {
        ...
        $this->success($this->deleteSuccessMessage());
        $this->deleted();
    ...
    | Success messages
    |--------------------------------------------------------------------------
    | Update success messages based on business requirements
    |
    */
    public function storeSuccessMessage()
    {
        return 'The '.Str::singular($this->module->title).' has been saved';
    }
