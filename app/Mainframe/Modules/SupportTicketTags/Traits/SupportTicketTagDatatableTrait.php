...
/** @mixin \App\Mainframe\Modules\SupportTicketTags\SupportTicketTagDatatable */
trait SupportTicketTagDatatableTrait
{
    /*---------------------------------
    ...
    public function source()
    {
        ...
        return SupportTicketTag::with(['updater:id,name']); // Model based query.
    }
