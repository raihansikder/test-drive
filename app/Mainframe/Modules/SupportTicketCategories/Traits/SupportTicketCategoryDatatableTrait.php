...
use App\Project\Modules\SupportTicketCategories\SupportTicketCategory;

trait SupportTicketCategoryDatatableTrait
{
    /*---------------------------------
    ...
    public function source()
    {
        ...
        return SupportTicketCategory::with(['updater:id,name']); // Model based query.
    }
    ...
    public function columns()
    {
        return [
            ...
            [$this->table.'.parent_name', 'parent_name', 'Parent Category'],
