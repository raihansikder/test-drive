...
trait UserTrait
{
    ...
    */
    ...
    {
        $upload = $this->uploads()
            ->where('type', Upload::TYPE_PROFILE_PIC)
            ->remember(timer('very-short'))
            ->first();
    ...
    */
    ...
    {
        $this->auth_token = $this->createAuthToken();
        $this->saveQuietly();
    ...
    */
    ...
    {
        return config(projectKey().'.config.default_email_recipients');
    }
