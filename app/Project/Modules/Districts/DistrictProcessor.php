...
class DistrictProcessor extends ModelProcessor
{
    ...
    */
    ...
    {
        $rules = [
            'name' => 'required|between:3,100|'.'unique:districts,name,'.($element->id ?? 'null').',id,deleted_at,NULL',
            'code' => 'required|digits_between:2,2|'.'unique:districts,code,'.($element->id ?? 'null').',id,deleted_at,NULL',
    ...
    */
    ...
    {
        $this->checkExistingRelations(['upazilas']);
