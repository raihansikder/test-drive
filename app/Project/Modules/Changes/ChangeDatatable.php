...
use App\Mainframe\Modules\Changes\Traits\ChangeDatatableTrait;

class ChangeDatatable extends \App\Mainframe\Modules\Changes\ChangeDatatable
{
    use ChangeDatatableTrait;

    public $moduleName = 'changes';
    ...
    //     return Change::with(['updater:id,name']); // Model based query.
    // }
