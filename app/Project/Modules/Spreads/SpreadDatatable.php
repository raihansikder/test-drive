...
class SpreadDatatable extends \App\Mainframe\Modules\Spreads\SpreadDatatable
{

    public $moduleName = 'spreads';
    ...
    //     return Spread::with(['updater:id,name']); // Model based query.
    // }
