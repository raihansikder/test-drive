...
class CreateModuleGroupsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Project/Modules/ModuleGroups';
        $module->namespace = '\\App\Project\Modules\ModuleGroups';
        $module->model = '\\App\Project\Modules\ModuleGroups\ModuleGroup';
        $module->policy = '\\App\Project\Modules\ModuleGroups\ModuleGroupPolicy';
        $module->processor = '\\App\Project\Modules\ModuleGroups\ModuleGroupProcessor';
        $module->controller = '\\App\Project\Modules\ModuleGroups\ModuleGroupController';
        $module->view_directory = 'project.modules.module-groups';
