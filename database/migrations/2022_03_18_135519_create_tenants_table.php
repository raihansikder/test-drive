...
class CreateTenantsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->module_table = 'tenants';
        $module->route_path = 'tenants';
        $module->route_name = 'tenants';
        $module->class_directory = 'app/Project/Modules/Tenants';
        $module->namespace = '\\App\Project\Modules\Tenants';
        $module->model = '\\App\Project\Modules\Tenants\Tenant';
        $module->policy = '\\App\Project\Modules\Tenants\TenantPolicy';
        $module->processor = '\\App\Project\Modules\Tenants\TenantProcessor';
        $module->controller = '\\App\Project\Modules\Tenants\TenantController';
        $module->view_directory = 'project.modules.tenants';
