...
class CreateCountriesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->module_table = 'countries';
        $module->route_path = 'countries';
        $module->route_name = 'countries';
        $module->class_directory = 'app/Project/Modules/Countries';
        $module->namespace = '\\App\Project\Modules\Countries';
        $module->model = '\\App\Project\Modules\Countries\Country';
        $module->policy = '\\App\Project\Modules\Countries\CountryPolicy';
        $module->processor = '\\App\Project\Modules\Countries\CountryProcessor';
        $module->controller = '\\App\Project\Modules\Countries\CountryController';
        $module->view_directory = 'project.modules.countries';
