...
class CreateChangesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Project/Modules/Changes';
        $module->namespace = '\\App\Project\Modules\Changes';
        $module->model = '\\App\Project\Modules\Changes\Change';
        $module->policy = '\\App\Project\Modules\Changes\ChangePolicy';
        $module->processor = '\\App\Project\Modules\Changes\ChangeProcessor';
        $module->controller = '\\App\Project\Modules\Changes\ChangeController';
        $module->view_directory = 'project.modules.changes';
