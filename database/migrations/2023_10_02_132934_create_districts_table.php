...
class CreateDistrictsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->default_route = 'districts';
        $module->class_directory = 'app/Project/Modules/Districts';
        $module->namespace = '\App\Project\Modules\Districts';
        $module->model = '\App\Project\Modules\Districts\District';
        $module->policy = '\App\Project\Modules\Districts\DistrictPolicy';
        $module->processor = '\App\Project\Modules\Districts\DistrictProcessor';
        $module->controller = '\App\Project\Modules\Districts\DistrictController';
        $module->view_directory = 'project.modules.districts';
