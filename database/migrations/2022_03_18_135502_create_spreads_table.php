...
class CreateSpreadsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Project/Modules/Spreads';
        $module->namespace = '\\App\Project\Modules\Spreads';
        $module->model = '\\App\Project\Modules\Spreads\Spread';
        $module->policy = '\\App\Project\Modules\Spreads\SpreadPolicy';
        $module->processor = '\\App\Project\Modules\Spreads\SpreadProcessor';
        $module->controller = '\\App\Project\Modules\Spreads\SpreadController';
        $module->view_directory = 'project.modules.spreads';
