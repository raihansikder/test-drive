...
class CreateContentsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Project/Modules/Contents';
        $module->namespace = '\\App\Project\Modules\Contents';
        $module->model = '\\App\Project\Modules\Contents\Content';
        $module->policy = '\\App\Project\Modules\Contents\ContentPolicy';
        $module->processor = '\\App\Project\Modules\Contents\ContentProcessor';
        $module->controller = '\\App\Project\Modules\Contents\ContentController';
        $module->view_directory = 'project.modules.contents';
