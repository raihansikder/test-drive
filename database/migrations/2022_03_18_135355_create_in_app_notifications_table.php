...
class CreateInAppNotificationsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Project/Modules/InAppNotifications';
        $module->namespace = '\\App\Project\Modules\InAppNotifications';
        $module->model = '\\App\Project\Modules\InAppNotifications\InAppNotification';
        $module->policy = '\\App\Project\Modules\InAppNotifications\InAppNotificationPolicy';
        $module->processor = '\\App\Project\Modules\InAppNotifications\InAppNotificationProcessor';
        $module->controller = '\\App\Project\Modules\InAppNotifications\InAppNotificationController';
        $module->view_directory = 'project.modules.in-app-notifications';
