...
class CreateModulesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Project/Modules/Modules';
        $module->namespace = '\\App\Project\Modules\Modules';
        $module->model = '\\App\Project\Modules\Modules\Module';
        $module->policy = '\\App\Project\Modules\Modules\ModulePolicy';
        $module->processor = '\\App\Project\Modules\Modules\ModuleProcessor';
        $module->controller = '\\App\Project\Modules\Modules\ModuleController';
        $module->view_directory = 'project.modules.modules';
