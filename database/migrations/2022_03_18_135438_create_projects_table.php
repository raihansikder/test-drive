...
class CreateProjectsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Project/Modules/Projects';
        $module->namespace = '\\App\Project\Modules\Projects';
        $module->model = '\\App\Project\Modules\Project';
        $module->policy = '\\App\Project\Modules\ProjectPolicy';
        $module->processor = '\\App\Project\Modules\ProjectProcessor';
        $module->controller = '\\App\Project\Modules\ProjectController';
        $module->view_directory = 'project.modules.projects';
