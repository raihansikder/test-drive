...
class CreateNotificationsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->module_table = 'notifications';
        $module->route_path = 'notifications';
        $module->route_name = 'notifications';
        $module->class_directory = 'app/Project/Modules/Notifications';
        $module->namespace = '\\App\Project\Modules\Notifications';
        $module->model = '\\App\Project\Modules\Notifications\Notification';
        $module->policy = '\\App\Project\Modules\Notifications\NotificationPolicy';
        $module->processor = '\\App\Project\Modules\Notifications\NotificationProcessor';
        $module->controller = '\\App\Project\Modules\Notifications\NotificationController';
        $module->view_directory = 'project.modules.notifications';
