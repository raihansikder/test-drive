...
class CreateSubscriptionsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->module_table = 'subscriptions';
        $module->route_path = 'subscriptions';
        $module->route_name = 'subscriptions';
        $module->class_directory = 'app/Project/Modules/Subscriptions';
        $module->namespace = '\\App\Project\Modules\Subscriptions';
        $module->model = '\\App\Project\Modules\Subscriptions\Subscription';
        $module->policy = '\\App\Project\Modules\Subscriptions\SubscriptionPolicy';
        $module->processor = '\\App\Project\Modules\Subscriptions\SubscriptionProcessor';
        $module->controller = '\\App\Project\Modules\Subscriptions\SubscriptionController';
        $module->view_directory = 'project.modules.subscriptions';
