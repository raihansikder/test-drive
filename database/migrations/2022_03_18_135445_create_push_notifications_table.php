...
class CreatePushNotificationsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $module->class_directory = 'app/Project/Modules/PushNotifications';
        $module->namespace = '\\App\Project\Modules\PushNotifications';
        $module->model = '\\App\Project\Modules\PushNotifications\PushNotification';
        $module->policy = '\\App\Project\Modules\PushNotifications\PushNotificationPolicy';
        $module->processor = '\\App\Project\Modules\PushNotifications\PushNotificationProcessor';
        $module->controller = '\\App\Project\Modules\PushNotifications\PushNotificationController';
        $module->view_directory = 'project.modules.push-notifications';
